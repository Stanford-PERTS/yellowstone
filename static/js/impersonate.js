...
PertsApp.controller('ImpersonateController', [
    '$scope', '$pertsAjax', '$q', '$timeout', '$window',
    function ($scope, $pertsAjax, $q, $timeout, $window) {
        'use strict';
        ...
        if (util.queryString('permission_denied') === 'true') {
            $scope.alert = {
                type: 'error',
